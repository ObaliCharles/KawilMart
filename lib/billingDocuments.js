...
export const buildRiderStatementDocument = ({
    ...
    return {
        ...
        html: buildDocumentShell({
            ...
            subtitle: `${riderName} for ${snapshot?.periodKey || "selected month"}. Delivery earnings come from completed or delivered jobs in that month, while the subscription fee comes from the rider account settings.`,
            ...
            metaBlocks: [
                renderMetaBlock("Rider account", [
                    ...
                    { label: "Billing month", value: snapshot?.periodKey || "Unknown" },
